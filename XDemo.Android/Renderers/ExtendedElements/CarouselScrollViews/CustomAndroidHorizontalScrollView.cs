...
{
    public class CustomAndroidHorizontalScrollView : AWidget.HorizontalScrollView
    {
        readonly CarouselScrollViewRenderer _renderer;

        public CustomAndroidHorizontalScrollView(Context context, CarouselScrollViewRenderer renderer) : base(context)
        {
            _renderer = renderer;
        }
